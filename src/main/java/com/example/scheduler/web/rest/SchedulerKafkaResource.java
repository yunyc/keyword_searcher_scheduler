...
@RestController
@RequestMapping("/api/scheduler-kafka")
public class SchedulerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SchedulerKafkaResource.class);
    ...
    public SchedulerKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
